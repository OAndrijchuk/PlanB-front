...
const Card = ({ master }: CardProps) => {
  ...
  return (
    <li className="relative h-[384px] w-[288px]">
      <Image
        src={img}
        alt={name}
        quality={90}
        ...
        //fill sizes ='100vw' quality={100} objectFit: cover width:100% height:auto
        className="rounded-xl w-[232px] h-[327.716px] flex-shrink-0" //h-48	height: 12rem; /* 192px */
      />
